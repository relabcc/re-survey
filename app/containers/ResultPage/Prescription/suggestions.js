...
export default {
  ...
  story: {
    ...
    extension: [
      { category: 'speech', name: 'Hans and Ola Rosling: How not to be ignorant about the world | TED', url: 'https://www.ted.com/talks/hans_and_ola_rosling_how_not_to_be_ignorant_about_the_world' },
      { category: 'book', name: '「人人都能上手的資訊圖表設計術」', url: `${googleSearch}人人都能上手的資訊圖表設計術` },
    ],
  },
  info: {
    ...
    extension: [
      { category: 'info', name: '實用資訊圖表分類', url: 'https://www.facebook.com/ReLAB.cc/posts/1579498278775394' },
      { category: 'book', name: '「人人都能上手的資訊圖表設計術」', url: `${googleSearch}人人都能上手的資訊圖表設計術` },
    ],
  },
};
